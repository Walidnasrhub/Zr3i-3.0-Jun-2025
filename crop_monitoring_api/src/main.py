...
from src.routes.satellite import satellite_bp
...
# Configure database
app.config['SQLALCHEMY_DATABASE_URI'] = f"sqlite:///{os.path.join(os.path.dirname(os.path.dirname(__file__)), 'crop_monitoring.db')}"
...
def health_check():
    return {'status': 'ok', 'message': 'Crop Monitoring API is running'}
